...
<div class="container">
    <div class="content">
        <div class="col-12 col-sm-10 col-lg-6  mx-auto bg-white p-4 shadow">
            ...
            <h3><b class="text-black" >Description</b></h3>
                ...
                <div class="d-flex justify-content-between ">
                    @auth
                    <a class="btn btn-primary rounded shadow-sm fw-bold h4 my-0 text-light" href="{{route('projects.index')}}">Go back</a>
        ...
        <div class="col-12 col-sm-10 col-lg-6  mx-auto d-flex justify-content-between ">
            @if ( session('status') )
            <div class="row m-0">
